...
* Test Steps
    ...
    1 Click on to the video tab it should display the contents.
	2 Verify wether video is present.
	
	

* Expected result
	
    1 Video page should be open. 
	2 video page should give valid video.
