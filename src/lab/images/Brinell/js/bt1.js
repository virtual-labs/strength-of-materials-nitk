...
function checkval()
{
	...
	// document.getElementById('text').style.disabled=true;
}
...
// {
    // myStopFunction();
    // var element = document.getElementById("2-8"); //arrow image
    ...
    // // document.getElementById('x').innerHTML=+pos.left;
	// if(flag==1)
		// var image=document.getElementById('2-9ci');
	// if(flag==2)
		// var image=document.getElementById('2-9ms');
	// if(flag==3)
		// var image=document.getElementById('2-9br');
	// if(flag==4)
		// var image=document.getElementById('2-9al');
		
	// image.style.top=parseFloat(image.style.top)+-0.15+'px';
	// if(pos.left==144)
	// {
...
// {
	...
	// document.getElementById('p2-1').style.visibility="hidden";
	// if(flag==1)
		// var image=document.getElementById('2-9ci2');
	// if(flag==2)
		// var image=document.getElementById('2-9ms2');
	// if(flag==3)
		// var image=document.getElementById('2-9br2');
	// if(flag==4)
		// var image=document.getElementById('2-9al2');
	// image.style.top=parseFloat(image.style.top)+-0.15+'px';
	// if(pos.left==144)
	// {
...
function touchScroll(event)
{
    ...
    //document.getElementById('4-7').innerHTML=+position.left;
	if(position.left>=54)
	{
...
function magic()
{
	...
	{ 
		...
		{
			elmt.innerHTML = "Move the mouse on the <br/>knob to measure the<br/>Impression diameter";
			moveKnobonHover();
		}
	...
	function step2()
	{
		...
		{
			elmt.innerHTML = "Move the mouse on the wheel<br/>to adjust specimen height";
			moveWheelonHover();
		}
		...
		setTimeout(function()
		{
			...
			if(repeat==1)
			{
			    $('#2-9').mousemove(function()
				{
					...
					//console.log("image.style.top = "+image.style.top+",   "+"count1="+count1 );
		...
		setTimeout(function()
		{
			...
			if(repeat==1)
			{
			    $('#2-9').click(function()
				{
		           ...
		           // var pos = $(element).offset();           //builtin function to find the HTML element's position 
					...
					//alert("image.style.top = "+image.style.top+",   "+"count2="+count2 );
			...
			if(repeat==2)
			{
				...
				$('#2-91').click(function() 
				{
					...
					// console.log("image.style.top = "+image.style.top+",   "+"count2="+count2 );
	...
	function moveKnobonHover()
	{
		if(repeat==1)
		{
			...
			$('#4-4').mousemove(function() 
			{
				...
				//console.log("element.style.left ="+element.style.left+", count2= "+count2);
	...
	function moveKnobonClick()
	{
		...
		if(repeat==1)
		{
			...
			$('#4-4').click(function() 
			{
				...
				//alert("element.style.left ="+element.style.left+", count2= "+count2);
